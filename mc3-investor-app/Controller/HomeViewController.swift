...
class HomeViewController: UIViewController {
    ...
    func initData() {
        ...
        let lessons: [Lesson] = [
            ...
            Lesson(id: 2, code: "lesson_2", name: "Liability", image: "2-lesson", desc1: ["A liability is something a person or company owes, usually a sum of money. Liabilities are settled over time through the transfer of economic benefits including money, goods, or services. Recorded on the right side of the balance sheet, liabilities include loans, accounts payable, mortgages, deferred revenues, bonds, warranties, and accrued expenses."], desc2: ["Liability is Debt, and generally the lesser the debt, the better it is for companies, however for banking and construction, we do need high liability or Debt because that is how their business generate money."], descImage: ["1-lesson", "2-lesson"], isLock: true),
            Lesson(id: 3, code: "lesson_3", name: "Earning Per Share", image: "3-lesson", desc1: ["Earnings per share (EPS) is calculated as a company's profit divided by the outstanding shares of its common stock. The resulting number serves as an indicator of a company's profitability. The higher a company's EPS, the more profitable it is considered."], desc2: ["The higher the EPS, it means the better the business is performing."], descImage: ["1-lesson", "2-lesson"], isLock: true),
            Lesson(id: 4, code: "lesson_4", name: "Return On Equity", image: "3-lesson", desc1: ["Return on equity (ROE) is a measure of financial performance calculated by dividing net income by shareholders' equity. Because shareholders' equity is equal to a company’s assets minus its debt, ROE is considered the return on net assets. ROE is considered a measure of how effectively management is using a company’s assets to create profits."], desc2: ["The higher the ROE , the better the business is performing."], descImage: ["1-lesson", "2-lesson"], isLock: true),
            Lesson(id: 5, code: "lesson_5", name: "Price to Book Value", image: "4-lesson", desc1: ["Price to Book Value (PBV) is the value of each shares when you take the equity of the company and divide it by the number of issued and fully paid shares."], desc2: ["The smaller the PBV, the better the bigger the margin of safety is for investors. PBV 1 means you are buying a billion dollar company’s equity for a billion dollars, PBV 0.1 means you are buying a billion dollar company’s equity with only 100 million dollars."], descImage: ["1-lesson", "2-lesson"], isLock: true),
            Lesson(id: 6, code: "lesson_6", name: "Debt to Equity Ratio", image: "5-lesson", desc1: ["The Debt to Equity Ratio (DER) is calculated by dividing a company’s total liabilities by its shareholder equity. It is a measure of the degree to which a company is financing its operations through debt versus wholly-owned funds. More specifically, it reflects the ability of shareholder equity to cover all outstanding debts in the event of a business downturn."], desc2: ["DER of below 1, is usually a sign of a healthy company, apart from financial companies or contractor companies. but DER of 1 is acceptable some of the best companies has no debt at all they are so good at earning money that they do not need to take on debt to expand. however they still will take on debts for tax reducing purposes."], descImage: ["1-lesson", "2-lesson"], isLock: true),
            Lesson(id: 7, code: "lesson_7", name: "Margin of Safety", image: "6-lesson", desc1: ["Margin of safety (MOS) is a principle of investing in which an investor only purchases securities when their market price is significantly below their intrinsic value. In other words, when the market price of a security is significantly below your estimation of its intrinsic value, the difference is the margin of safety. Because investors may set a margin of safety in accordance with their own risk preferences, buying securities when this difference is present allows an investment to be made with minimal downside risk."], desc2: ["The higher the MOS, the safer an investor can feel when buying shares. it is like a safety buffer between the price paid by investors and the real intrinsic value of the shares."], descImage: ["1-lesson", "2-lesson"], isLock: true),
        ]
